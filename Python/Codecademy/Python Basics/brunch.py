class Menu:
    ...
    def calculate_bill(self, purchased_items):
        ...
        for food in purchased_items:
            if food in self.items.keys():
                sum_items += self.items[food]
        return sum_items
...
brunch_items = {'pancakes': 7.50, 'waffles': 9.00, 'burger': 11.00,
...
take_arepa_items = {'arepa pabellon': 7.00, 'pernil arepa': 8.50, 'guayanes arepa': 8.00, 'jamon arepa': 7.50}

brunch_menu = Menu("Brunch", brunch_items, 1100, 1600)
early_bird_menu = Menu("Early Bird", early_bird_items, 1300, 1800)
dinner_menu = Menu("Dinner", dinner_items, 1700, 2300)
kids_menu = Menu("Kids", kids_items, 1100, 2100)
arepas_menu = Menu("Take a’ Arepa", take_arepa_items, 1000, 2000)
